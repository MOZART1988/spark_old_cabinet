...
class task implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($lead_id, $text, $manager, $manager_id)
    {
    ...
    public function handle()
    {
        ...
        if ($this->manager_id != 0) {
            ...
            $tasks['add'] = array(
                ...
                array(
                    'element_id'          => $this->lead_id, #ID сделки
            ...
            $tasks['add'] = array(
                ...
                array(
                    ...
                    'task_type'           => 866386,
                    'text'                => $this->text,
                    'responsible_user_id' => \Config::get('managers.manager_names.' . $this->manager),
                    'complete_till_at'    => strtotime('tomorrow 12:00'),
                ),
            );
        }
